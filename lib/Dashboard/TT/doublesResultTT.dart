...
class DoublesResultTT extends StatefulWidget {
  ...
  @override
  State<DoublesResultTT> createState() => _DoublesResultTTState();
}

class _DoublesResultTTState extends State<DoublesResultTT> {
  // bool isPlaying = true;
