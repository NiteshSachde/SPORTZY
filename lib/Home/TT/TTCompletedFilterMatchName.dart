...
class TTCompletedFilterMatchName extends StatefulWidget {
  const TTCompletedFilterMatchName({super.key});
  @override
  State<TTCompletedFilterMatchName> createState() =>
      _TTCompletedFilterMatchNameState();
}

class _TTCompletedFilterMatchNameState
    extends State<TTCompletedFilterMatchName> {
  bool _isSingle = true;
  List searchResult = [];
  List searchResult2 = [];
