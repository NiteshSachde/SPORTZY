...
import 'package:sportzy/Home/TT/TTLiveFilterLocation.dart';
import 'package:sportzy/Others/firestoreFields.dart';

import 'TTLiveFilterMatchName.dart';

class LiveScreenTT extends StatefulWidget {
  const LiveScreenTT({super.key});
  @override
  State<LiveScreenTT> createState() => _LiveScreenTTState();
}

class _LiveScreenTTState extends State<LiveScreenTT> {
  bool _isSingle = true;
