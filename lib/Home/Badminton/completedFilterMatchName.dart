...
class CompletedFilterMatchName extends StatefulWidget {
  const CompletedFilterMatchName({super.key});
  @override
  State<CompletedFilterMatchName> createState() =>
      _CompletedFilterMatchNameState();
}

class _CompletedFilterMatchNameState extends State<CompletedFilterMatchName> {
  bool _isSingle = true;
  List searchResult = [];
  List searchResult2 = [];
